module.exports.run = async (client, message, args) => {
  ...
  async function player() {
    ...
    if (urlValid) {
      ...
      try {
        ...
        song = { title: songInfo.videoDetails.title, url: songInfo.videoDetails.video_url, duration: songInfo.videoDetails.lengthSeconds };
      } catch (error) { console.error(error); return message.channel.send(client.comment(`No video was found with a matching title`)); }
    }
  ...
  async function playlist() {
    ...
    if (urlValid) {
      ...
      } catch (error) { console.error(error); return message.channel.send(client.comment(`Playlist not found`)); };
    } else {
      try {
